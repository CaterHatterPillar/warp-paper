...
Thus, we investigate a more optimized kernel to see whether or not this behavior may be replicated in the experiment in terms of memory access.
...
\begin{center}
	...
	\caption{Execution time using WARP with floating point-precision for the Basic and Tiled kernels, indicated by their respective mean- and separated by standard deviation values. Samples outside of respective standard deviation are not presented.}
