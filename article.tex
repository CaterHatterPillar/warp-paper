...
\begin{description*}
	...
	\item[OS]	Windows 8.0
\end{description*}
The study has been performed on this system as Microsoft claims that the \textit{WARP}~driver performs best on modern quad-core \textit{CPU}s\footref{lab:warpguide}.
...
\begin{tabular}{r|r|r|r|}
	\cline{2-3}
							& \multicolumn{1}{|c|}{\textbf{BASIC}} & \multicolumn{1}{|c|}{\textbf{TILE}}	\\ \hline
...
%In both int- and float-cases, warp performs worse with memory tiling, whereas ref-device is less impaired or even performs better. why?
...
\begin{figure}[htb]
\begin{center}
	\resizebox{ \columnwidth }{!}{\input{msshard}}
